...
If you have any difficulties or annoyances using the site, or feel that we are not meeting accessibility requirements, then please contact us ([contact@elixiruknode.org](mailto:contact@elixiruknode.org)). We will do our best to make the site easier to use.
...
## Level of compliance
As far as we can ascertain, this website is compliant with the Web Content Accessibility Guidelines version 2.1 AA standard. If you feel there are issues to address, however, then please email [contact@elixiruknode.org](mailto:contact@elixiruknode.org).
